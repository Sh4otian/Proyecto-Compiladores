    ...
    public partial class FormFirstFollowLl1 : Form
    {
        ...
        private void btnProcesar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                grammar = Grammar.Parse(txtGrammar.Text);
                firstSets = grammar.ComputeFirst();
                followSets = grammar.ComputeFollow(firstSets);
                ll1Result = grammar.BuildLL1Table(firstSets, followSets);
